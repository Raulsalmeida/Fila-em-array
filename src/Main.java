		...
		while(resposta != 0) {
			...
			switch(resposta) {
                ...
                case 3:
                    ...
                    System.out.println("\n--->Seu elemento do inicio ï¿½ "+topo2+"!<---");
                	}catch(EFilaVazia e1){
                		System.out.println("Sua fila estï¿½ vazia, nï¿½o tem o que ver no topo dela");
                	}
                    break;
                ...
                case 5:
                    ...
                    if (situacao==true){
                        ...
                        System.out.println("Nï¿½o! a fila nï¿½o estï¿½ vazia. Contï¿½m "+ qtd +" elementos!");
                    }
                    break;
